...
const url = "https://silverthornresort.com/about/history";
const title =
...
export const Route = createFileRoute("/about/history")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: `https://silverthornresort.com${heroMarina}` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: title },
      { name: "twitter:description", content: description },
      { name: "twitter:image", content: `https://silverthornresort.com${heroMarina}` },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description,
          image: [`https://silverthornresort.com${heroMarina}`],
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "About", item: "https://silverthornresort.com/about/history" },
