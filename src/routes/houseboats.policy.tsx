...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          Silverthorn Resort is a pet-friendly resort and welcomes a <strong>maximum of 2 dogs per houseboat</strong> —
          the <strong>1st dog stays free</strong> and the <strong>2nd dog is a non-refundable $50.00</strong>, paid
          prior to occupancy/boarding.
        </p>
        <p>
